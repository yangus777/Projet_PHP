...
<!-- Form Item Creation-->
	...
	echo '<table style="border : solid black 1px;"><thead><tr><th>ID Item</th><th>Name</th></tr></thead><tbody>';
		while ($row=mysql_fetch_array($res, MYSQL_BOTH)){		
			echo '<tr><td style="border : solid black 1px;">'.$row["id_item"].'</td>';
			echo '<td><a href="modify_item.php?id_item='.$row['id_item'].'">' .$row["name"].'</a></td></tr>';
		}
